...
Operation operations[] =
{
    ...
    {0, OP_ROOT   , TWO_ARGS , "root"   , CalcRoot   , WriteRootInTeX   , TakeDerivativeRoot   , RemoveNeutElemRoot},
    {0, OP_SQRT   , ONE_ARG  , "sqrt"   , CalcSqrt   , WriteSqrtInTeX   , TakeDerivativeSqrt   , NULL              },
